...
whiskeyCocktails.push(new Cocktail('Whiskey', 'Old Fashioned', ['1 oz Whiskey', '2 DASHES BITTERS', '1 SUGAR CUBE', 'ORANGE PEEL (FOR GARNISH'], 'old_glory.jpg', 'In an Old-Fashioned glass, muddle the sugar and bitters.Add a large ice cube.Add whiskey on top of the muddled sugar and stir with your bar spoon.Garnish with a orange twist (if desired)'));

whiskeyCocktails.push(new Cocktail('Whiskey', 'Manhattan', ['2 oz Whiskey', '1 oz sweet vermouth', '2 dashes orange bitters', '1 dash angostura bitters', '1 cherry'], 'manhattan.jpg', 'Stir all ingredients with ice and strain into a chilled coupe glass.Serve with a brandied cherry.'));
...
ginCocktails.push(new Cocktail('Gin', 'Gin and Tonic', ['2 oz gin', '3-4 oz tonic water'], 'gin_tonic.jpg', 'Add gin to a highball glass filled with ice. Squeeze in lime wedges to taste Add them to glass. Add tonic water; stir to combine'));
ginCocktails.push(new Cocktail('Gin', 'Negroni', ['1 oz gin', ' 1 oz campari', '1 oz sweet vermouth ', 'sugar'], 'negroni.jpg', 'Add all the ingredients into a mixing glass with ice, and stir until well-chilled.Strain into a rocks glass filled with large ice cubes.Garnish with an orange peel'));
ginCocktails.push(new Cocktail('Gin', 'Tom Collins', ['3/4 lemon juice', 'Coke', '3/4 oz simple syrup', 'club soda'], 'tom_collins.jpg', 'Add the lemon juice, simple syrup and gin into a shaker with ice and shake well.Strain into a highball or Collins glass over fresh ice.Top with club soda.Garnish with a lemon wheel and cherry, and serve with a straw'));
...
ginCocktails.push(new Cocktail('Gin', 'Salty dog', ['1.5 oz gin', '3 oz grapefruit juice', '4tsp salt', 'sugar'], 'salty_dog.jpg', 'Rim a highball glass with salt.Shake the vodka (or gin) and grapefruit juice, pour over ice in a highball glass.Garnish with a grapefruit slice'));
ginCocktails.push(new Cocktail('Gin', 'Gin Martini', ['1 oz gin', '1dry vermouth', 'olives'], 'gin_martini.jpg', 'pour over ice. stir or shake to taste'));
...
'daiquiri.jpg', 'Add all the ingredients into a shaker with ice, and shake until well-chilled.Strain into a chilled coupe.Garnish with a lime twist'));
rumCocktails.push(new Cocktail('Rum', 'Dark n Stormy', ['1.5 oz Rum (dark)', 'ginger beer '], 'dark_n_stormy.jpg', 'Fill a tall glass with ice, and add the rum.Top with the ginger beer.Garnish with a lime wedge'));
...
tequilaCocktails.push(new Cocktail('Tequila', 'Horny Bull', ['2 oz tequila', ' 3 Orange juice'], 'horny_bull.jpg', 'Fill tall glass with ice and pour in tequila. Stir 2-3 timesTop off with OJ and serve'));
tequilaCocktails.push(new Cocktail('Tequila', 'Juan Collins', ['4.5 oz tequila (Hornitos Plata Tequila recommended)', '1.5 oz lemon juice', '1 tsp. sugar', '9 oz. club soda'], 'juan_collins.jpg', 'Rim glass with salt or sugar. Fill glass with ice. Add tequila and lime juice, and stir. Top off with grapefruit juice and soda. Stir again. Garnish and serve!'));
tequilaCocktails.push(new Cocktail('Tequila', 'Salty Chihuahua (with Lemonade)', ['1.5 oz tequila', ' 5 oz lemonade', 'splash of lime juice', 'Lime wedge, and coarse salt or sugar for garnish (optional)'], 'salty_chihuhuahu.jpg', 'Rim glass with salt or sugar. Fill glass with ice. Pour in tequila and lemonade. Squeeze and drop in lime wedge for a splash of lime juice. Stir and serve'));
tequilaCocktails.push(new Cocktail('Tequila', 'Tequila Sunrise', ['1.5 oz tequila', ' 3 oz orange juice', '1/2 oz. grenadine syrup', 'Orange Slice/Maraschino Cherry (for garnish)'], 'tequila_sunrise.jpg', 'Add ice to tall glass and pour over tequila and orange juice.Slowly add the grenadine which will sink to the bottom of the glass.Garnish with an orange slice and a maraschino cherry'));
tequilaCocktails.push(new Cocktail('Tequila', 'Tommy\'s margarita', ['2 oz tequila', ' 1 ounce lime juice (preferably squeezed)', '.5 oz agave syrup'], 'tommys_margarita.jpg', 'Combine all ingredients in a shaker over ice. Shake to chill Strain over fresh ice. Salt garnish (optional)'));
tequilaCocktails.push(new Cocktail('Tequila', 'Tequila Negroni', ['1 oz tequila', ' 1 Campari', '1 sweet red vermouth'], 'tequila_negrroni.jpg', 'Combine all ingredients in a lowball glass with ice Stir to chill. Dilute slightly'));
tequilaCocktails.push(new Cocktail('Tequila', 'Tequila soda', ['2 oz tequila', ' 3 oz club soda', 'Lime wedge'], 'tequila_soda.jpg', 'Pour the tequila over ice in a tall glass.  Fill with club soda.   Squeeze in lime wedge, and enjoy'));
cognacCocktails.push(new Cocktail('Cognac', 'Sidecar', ['2 oz cognac', ' 1 oz lemon juice', '.5 oz simple syrup'], 'tequila_soda.jpg', 'Rim a coupe glass with sugar (or don’t… this is America, and we’re not gonna tell you what to do). Shake all ingredients with ice until chilled. Strains  Serve straight up'));

cognacCocktails.push(new Cocktail('Cognac', 'Spiked Coffee', ['2 oz cognac', ' 4 ounces coffee', '1 ounce Kahlua'], 'spiked_coffee.jpg','Pour the Kahlua and Cognac into your coffee. Stir and wake up'));
cognacCocktails.push(new Cocktail('Cognac', 'Cognac Manhattan', ['2 oz cognac', ' 3/4 red vermouth', '2 dashes bitters'], 'cognac_manhattan.jpg', 'Stir all ingredients together with ice until chilled. Strain into a glass. Serve and enjoy'));
cognacCocktails.push(new Cocktail('Cognac', 'Spiked cider', ['2 oz cognac', ' 4 oz apple cider', 'Orange peel'], 'spiked_cider.jpg', 'Combine the cider and Cognac over ice. Twist the orange peel to release the oils over the top of the drinks. Then sink it in'));
cognacCocktails.push(new Cocktail('Cognac', 'Ode To Tiki', ['2 oz cognac', ' 1 oz orgeat', '1 oz lemon juice'], 'ode_to_tiki.jpg', 'Shake all ingredients over ice. pour into a glass. Enjoy!'));
