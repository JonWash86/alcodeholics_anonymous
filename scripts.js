...
whiskeyCocktails.push(new Cocktail('Whiskey', 'Old Fashioned', ['1 oz Whiskey', '2 dashes bitters', '1 sugar cube', 'orange peel (for garnish)'], 'old_glory.jpg', 'In an Old-Fashioned glass, muddle the sugar and bitters.<br>Add a large ice cube.<br>Add whiskey on top of the muddled sugar and stir with your bar spoon.<br>Garnish with a orange twist (if desired).', ['bitters', 'sugar', 'orange']));

whiskeyCocktails.push(new Cocktail('Whiskey', 'Manhattan', ['2 oz Whiskey', '1 oz sweet vermouth', '2 dashes orange bitters', '1 dash angostura bitters', '1 cherry'], 'manhattan.jpg', 'Stir all ingredients with ice and strain into a chilled coupe glass.<br>Serve with a brandied cherry.',['sweet vermouth', 'bitters', 'cherry']));
...
ginCocktails.push(new Cocktail('Gin', 'Gin and Tonic', ['2 oz gin', '3-4 oz tonic water'], 'gin_tonic.jpg', 'Add gin to a highball glass filled with ice. Squeeze in lime wedges to taste<br> Add them to glass. Add tonic water; stir to combine.', ['tonic water']));
ginCocktails.push(new Cocktail('Gin', 'Negroni', ['1 oz gin', ' 1 oz campari', '1 oz sweet vermouth ', 'sugar'], 'negroni.jpg', 'Add all the ingredients into a mixing glass with ice, and stir until well-chilled.<br>Strain into a rocks glass filled with large ice cubes.<br>Garnish with an orange peel.', ['campari', 'sweet vermouth', 'sugar']));
ginCocktails.push(new Cocktail('Gin', 'Tom Collins', ['3/4 lemon juice', 'Coke', '3/4 oz simple syrup', 'club soda'], 'tom_collins.jpg', 'Add the lemon juice, simple syrup and gin into a shaker with ice and shake well.<br>Strain into a highball or Collins glass over fresh ice.<br>Top with club soda.<br>Garnish with a lemon wheel and cherry, and serve with a straw.', ['lemon', 'coke', 'sugar', 'club soda']));
ginCocktails.push(new Cocktail('Gin', 'Gimlet', ['2.5 oz gin', '.5 oz lime juice', '.5 oz simple syrup'], 'gimlet.jpg', 'Add all the ingredients into a shaker with ice and shake.<br>Strain into a chilled cocktail glass or an Old Fashioned glass filled with fresh ice.<br>Garnish with a lime wheel.<br>(You can substitute 1 oz lime cordial, such as Rose\'s Lime Juice, for both the lime juice and simple syrup).', ['lime', 'sugar']));
ginCocktails.push(new Cocktail('Gin', 'Gin Fizz', ['2 oz gin', '1 oz lemon juice', '3/4 oz simple syrup'], 'gin_fizz.jpg', 'Add all the ingredients into a shaker with ice and shake.<br>Strain into a chilled cocktail glass or an Old Fashioned glass filled with fresh ice.<br>Garnish with a lime wheel.<br>(You can substitute 1 oz lime cordial, such as Rose\'s Lime Juice, for both the lime juice and simple syrup).', ['lemon', 'sugar']));
ginCocktails.push(new Cocktail('Gin', 'Salty dog', ['1.5 oz gin', '3 oz grapefruit juice', '4tsp salt', 'sugar'], 'salty_dog.jpg', 'Rim a highball glass with salt.<br>Shake the vodka (or gin) and grapefruit juice, pour over ice in a highball glass.<br>Garnish with a grapefruit slice.',['grapefruit juice', 'salt', 'sugar']));
ginCocktails.push(new Cocktail('Gin', 'Gin Martini', ['1 oz gin', '1dry vermouth', 'olives'], 'gin_martini.jpg', 'pour over ice.<br> stir or shake to taste', ['dry vermouth', 'olives']));

rumCocktails.push(new Cocktail('Rum', 'Mojito', ['1.5 oz rum', 'mint leaves', '3/4 oz simple syrup', '1.5 club soda'], 'mojito.jpg', 'In a shaker, lightly muddle the mint.<br>Add the simple syrup, lime juice and rum, and fill with ice.<br>Shake well and pour (unstrained) into a highball glass.<br>Top with the club soda and garnish with a mint sprig.',['mint', 'sugar', 'club soda']));
rumCocktails.push(new Cocktail('Rum', 'Mai Tai', ['2 oz Rum', '3/4 oz lime juice', '1/4 rock candy syrup \(simple syrup with a 2 parts sugar to 1 part water ratio\)', '1/4 orgeat almond syrup', '.5 orange curacao'], 'mai_tai.jpg', 'Add all the ingredients to a shaker and fill with crushed ice.<br>Shake vigorously until the shaker is well-chilled and frosty on the outside.<br>Pour \(unstrained\) into a double Old Fashioned glass.<br>Garnish with half of a juiced lime and a fresh mint sprig.', ['lime', 'sugar', 'orgeat', 'orange curacao']));
...
'daiquiri.jpg', 'Add all the ingredients into a shaker with ice, and shake until well-chilled.<br>Strain into a chilled coupe.<br>Garnish with a lime twist.', ['lime', 'sugar']));
rumCocktails.push(new Cocktail('Rum', 'Dark n Stormy', ['1.5 oz Rum (dark)', 'ginger beer '], 'dark_n_stormy.jpg', 'Fill a tall glass with ice, and add the rum.<br>Top with the ginger beer.<br>Garnish with a lime wedge', ['ginger beer']));
...
tequilaCocktails.push(new Cocktail('Tequila', 'Horny Bull', ['2 oz tequila', ' 3 Orange juice'], 'horny_bull.jpg', 'Fill tall glass with ice and pour in tequila. Stir 2-3 times<br>Top off with OJ and serve.', ['orange juice']));
tequilaCocktails.push(new Cocktail('Tequila', 'Juan Collins', ['4.5 oz tequila (Hornitos Plata Tequila recommended)', '1.5 oz lemon juice', '1 tsp. sugar', '9 oz. club soda'], 'juan_collins.jpg', 'Rim glass with salt or sugar.<br> Fill glass with ice. Add tequila and lime juice, and stir.<br> Top off with grapefruit juice and soda.<br> Stir again.<br> Garnish and serve.!', ['lemon', 'sugar', 'club soda']));
tequilaCocktails.push(new Cocktail('Tequila', 'Salty Chihuahua (with Lemonade)', ['1.5 oz tequila', ' 5 oz lemonade', 'splash of lime juice', 'Lime wedge, and coarse salt or sugar for garnish (optional)'], 'salty_chihuhuahu.jpg', 'Rim glass with salt or sugar.<br> Fill glass with ice.<br> Pour in tequila and lemonade.<br> Squeeze and drop in lime wedge for a splash of lime juice.<br> Stir and serve.', ['lemonade', 'lime', 'salt']));
tequilaCocktails.push(new Cocktail('Tequila', 'Tequila Sunrise', ['1.5 oz tequila', ' 3 oz orange juice', '1/2 oz. grenadine syrup', 'Orange Slice/Maraschino Cherry (for garnish)'], 'tequila_sunrise.jpg', 'Add ice to tall glass and pour over tequila and orange juice.<br>Slowly add the grenadine which will sink to the bottom of the glass.<br>Garnish with an orange slice and a maraschino cherry.', ['orange juice', 'grenadine syrup']));
tequilaCocktails.push(new Cocktail('Tequila', 'Tommy\'s margarita', ['2 oz tequila', ' 1 ounce lime juice \(preferably squeezed\)', '.5 oz agave syrup'], 'tommys_margarita.jpg', 'Combine all ingredients in a shaker over ice.<br> Shake to chill<br> Strain over fresh ice. <br>Salt garnish \(optional\).', ['lime', 'agave syrup']));
tequilaCocktails.push(new Cocktail('Tequila', 'Tequila Negroni', ['1 oz tequila', ' 1 Campari', '1 sweet red vermouth'], 'tequila_negrroni.jpg', 'Combine all ingredients in a lowball glass with ice<br> Stir to chill.<br> Dilute slightly.', ['campari', 'sweet vermouth']));
tequilaCocktails.push(new Cocktail('Tequila', 'Tequila soda', ['2 oz tequila', ' 3 oz club soda', 'Lime wedge'], 'tequila_soda.jpg', 'Pour the tequila over ice in a tall glass. <br> Fill with club soda. <br>  Squeeze in lime wedge, and enjoy.', ['club soda', 'lime']));
cognacCocktails.push(new Cocktail('Cognac', 'Sidecar', ['2 oz cognac', ' 1 oz lemon juice', '.5 oz simple syrup'], 'tequila_soda.jpg', 'Rim a coupe glass with sugar (or don’t… this is America, and we’re not gonna tell you what to do).<br> Shake all ingredients with ice until chilled.<br> Strains <br> Serve straight up.', ['lemon', 'sugar']));

cognacCocktails.push(new Cocktail('Cognac', 'Spiked Coffee', ['2 oz cognac', ' 4 ounces coffee', '1 ounce Kahlua'], 'spiked_coffee.jpg','Pour the Kahlua and Cognac into your coffee.<br> Stir and wake up.', ['coffee', 'coffee liqueur']));
cognacCocktails.push(new Cocktail('Cognac', 'Cognac Manhattan', ['2 oz cognac', ' 3/4 red vermouth', '2 dashes bitters'], 'cognac_manhattan.jpg', 'Stir all ingredients together with ice until chilled.<br> Strain into a glass.<br> Serve and enjoy.', ['sweet vermouth', 'bitters']));
